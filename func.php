...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i>Hospital Managment System</a>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="doctor" class="form-control" >
                     <option value="Dr. yameen">Dr. yameen</option>
                      <option value="Dr. Salman">Dr. salman</option>
                      <option value="Dr. Waseem">Dr. Waseem</option>
                      <option value="Dr. Mustafa">Dr. Mustafa</option>
                      <option value="Dr. Sumiyal">Dr. Sumiyal</option>
                      <option value="Dr. Afsar">Dr. Afsar</option>
